...
const Reset = () => {
  ...
  return (
    <>
     ...
     bg-blue-600 xs:w-[85%] lg:w-[57%] h-[78%] py-1"
        >
          <div
            // shadow-[0_8px_30px_rgb(0,0,0,0.15)]  backdrop-blur-md bg-white/35
            className="lg:flex xs:hidden w-[48%] flex-col items-center
          justify-between p-5 rounded-t-none rounded-b-none
          rounded-3xl h-[95%] text-white"
          >
            <div className="w-full mt-[10px]">
              <div className="mb-3 text-2xl font-bold">Reset </div>
              <div className="text-sm">
                Reset your password to regain access to your Orders, Wishlist,
                and Recommendations.
              </div>
            </div>
            <div className="">
          ...
          <div className="xs:w-full lg:w-[51%] h-full rounded-3xl backdrop-blur-xl bg-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] ">
            <div className="flex flex-col items-center justify-center w-full h-full p-8 rounded-3xl ">
              <div className="flex flex-col items-center justify-center gap-1 my-10">
                ...
                <div className="text-sm font-semibold ">Don't Worry!</div>
              </div>
              <form
              ...
              >
                ...
                <button
                  type="submit"
                  className={`block w-full p-3 px-5 mt-1 rounded-2xl mb-5 font-bold text-white transition-all hover:scale-[1.04] text-sm ${"bg-theme-purple hover:bg-theme-purple600"}`}
                >
                  Reset Password
                </button>
                <Divider />
                <div className="flex justify-between my-1 mb-10 text-xs bg-red-">
                  <Link to="/signup">
