            ...
            <div className="flex flex-col items-center justify-center w-full h-full p-8 rounded-3xl ">
              ...
              >
                  ...
                  <div
                    className={`${
                      validated || validationMsg === "Invalid email id."
                        ? "text-black"
                        : "text-red-500"
                    } text-[11px] absolute xs:right-9 lg:left-[21.75rem] scale-75 cursor-pointer lg:mt-[.7rem] xs:mt-[5.4rem]`}
                  >
                    {showPassword ? (
                ...
                <div
                  className={`${
                    validated || validationMsg === "Invalid email id."
                      ? "text-black"
                      : "text-red-500"
                  } text-[11px] absolute xs:right-9 lg:left-[21.75rem] scale-75 cursor-pointer lg:mt-[10.5rem] xs:mt-[5.4rem]`}
                >
                  {showCPassword ? (
               ...
               absolute lg:mt-[10.4rem] xs:mt-[5.rem] ml-[.9rem]`}
                ...
                <button
                  type="submit"
                  className={`block w-full p-3 px-5 rounded-2xl font-bold text-white transition-all hover:scale-[1.04] text-sm ${"bg-theme-purple hover:bg-theme-purple600"}`}
                >
                  Register
                </button>
                <div className="text-[10.5px] my-3">
                ...
                <Divider />
                <div className="flex justify-center mt-4 text-xs bg-red-">
